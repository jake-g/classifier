...
def findOverfeatDir(file_dir):
    try:
        ...
        pass
    if (file_dir[-12:] == "classifier/linux_32") or (file_dir[-12:] == "classifier/linux_64") or (file_dir[-9:] == "classifier/macos"):
        return path.abspath(path.join(file_dir, "../.."))
    if (file_dir[-15:] == "classifier/linux_32/cuda") or (file_dir[-15:] == "classifier/linux_64/cuda") or (file_dir[-14:] == "classifier/macos/cuda"):
        return path.abspath(path.join(file_dir, "../../.."))
    elif file_dir[-3:] == "src":
        return path.abspath(path.join(file_dir, ".."))
    else:
